...
export default function Search() {
  return (
    <div className="bg-gray-100 rounded-full flex p-2 items-center gap-2 ">
        ...
        <input className="bg-transparent border-none outline-none" type="text" placeholder="search a post..." />
    </div>
  )
}
